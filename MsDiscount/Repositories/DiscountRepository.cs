using Dapper;
using MsDiscount.Entities;
using Npgsql;

namespace MsDiscount.Repositories
{
    public class DiscountRepository : IDiscountRepository
    {
        ...
        private NpgsqlConnection GetConnectionPostgreeSQL()
        {
        ...
        {
            NpgsqlConnection connection = GetConnectionPostgreeSQL();
